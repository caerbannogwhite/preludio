...
// This class defines a complete listener for a parse tree produced by preludioParser.
export default class preludioListener extends antlr4.tree.ParseTreeListener {
  // Enter a parse tree produced by preludioParser#nl.
  enterNl(ctx) {}

  // Exit a parse tree produced by preludioParser#nl.
  exitNl(ctx) {}

  // Enter a parse tree produced by preludioParser#program.
  enterProgram(ctx) {}

  // Exit a parse tree produced by preludioParser#program.
  exitProgram(ctx) {}

  // Enter a parse tree produced by preludioParser#programIntro.
  enterProgramIntro(ctx) {}

  // Exit a parse tree produced by preludioParser#programIntro.
  exitProgramIntro(ctx) {}
  ...
  // Enter a parse tree produced by preludioParser#stmt.
  enterStmt(ctx) {}

  // Exit a parse tree produced by preludioParser#stmt.
  exitStmt(ctx) {}
  ...
  // Enter a parse tree produced by preludioParser#identBacktick.
  enterIdentBacktick(ctx) {}

  // Exit a parse tree produced by preludioParser#identBacktick.
