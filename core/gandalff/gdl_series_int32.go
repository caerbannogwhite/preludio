...
func (s SeriesInt32) Mul(other Series) Series {
	// This function has been generated by the code generator at https://github.com/caerbannogwhite/preludio/tree/main/core/gandalff/gen
	// This function is auto-generated. DO NOT EDIT.
	switch o := other.(type) {
	case SeriesInt32:
		if s.Len() == 1 {
			if o.Len() == 1 {
