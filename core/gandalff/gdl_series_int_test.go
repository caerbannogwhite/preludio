...
func Test_SeriesInt_Base(t *testing.T) {
	...
	s := NewSeriesInt(data, mask, true, nil)
	...
	p := NewSeriesInt(data, nil, true, nil)
...
func Test_SeriesInt_Append(t *testing.T) {
	...
	sA := NewSeriesInt(dataA, maskA, true, nil)
	sB := NewSeriesInt(dataB, maskB, true, nil)
	sC := NewSeriesInt(dataC, maskC, true, nil)
	...
	sD := NewSeriesInt(dataD, nil, true, nil)
	...
	for i := 0; i < 100; i++ {
		...
		switch i % 4 {
		case 0:
			sD = sD.Append(r).(SeriesInt)
		case 1:
			sD = sD.Append([]int{r}).(SeriesInt)
		case 2:
			sD = sD.Append(NullableInt{true, r}).(SeriesInt)
		case 3:
			sD = sD.Append([]NullableInt{{false, r}}).(SeriesInt)
		}
...
func Test_SeriesInt_Cast(t *testing.T) {
	...
	// Create a new series.
	s := NewSeriesInt(data, mask, true, NewStringPool())
...
func Test_SeriesInt_Filter(t *testing.T) {
	...
	if e, ok := filtered.(SeriesError); !ok || e.GetError() != "SeriesInt.FilterByMask: mask length (20) does not match series length (14)" {
...
func Test_SeriesInt_Map(t *testing.T) {
	...
	// Create a new series.
	s := NewSeriesInt(data, nullMask, true, NewStringPool())
...
func Test_SeriesInt_Group(t *testing.T) {
	...
	// Test 1
	s1 := NewSeriesInt(data1, data1Mask, true, nil).
		group()
	...
	// Test 2
	s2 := NewSeriesInt(data2, data2Mask, true, nil).
	...
	// Test 3
	s3 := NewSeriesInt(data3, data3Mask, true, nil).
...
func Test_SeriesInt_Sort(t *testing.T) {
	...
	// Create a new series.
	s := NewSeriesInt(data, nil, true, nil)
