...
func Test_SeriesBool_Base(t *testing.T) {
	...
	s := NewSeriesBool(true, true, data, nil)
	...
	p := NewSeriesBool(false, true, data, nil)
...
func Test_SeriesBool_Append(t *testing.T) {
	...
	sA := NewSeriesBool(true, true, dataA, nil)
	sB := NewSeriesBool(true, true, dataB, nil)
	sC := NewSeriesBool(true, true, dataC, nil)
	...
	sD := NewSeriesBool(true, true, dataD, nil)
...
func Test_SeriesBool_Cast(t *testing.T) {
	...
	// Create a new series.
	s := NewSeriesBool(true, true, data, NewStringPool())
...
func Test_SeriesBool_LogicOperators(t *testing.T) {
	...
	not := NewSeriesBool(true, true, dataA, nil).
...
func Test_SeriesBool_Group(t *testing.T) {
	...
	// Test 1
	s1 := NewSeriesBool(true, true, data1, nil).
	...
	// Test 2
	s2 := NewSeriesBool(true, true, data2, nil).
	...
	// Test 3
	s3 := NewSeriesBool(true, true, data3, nil).
...
func Test_SeriesBool_Sort(t *testing.T) {
	...
	// Create a new series.
	s := NewSeriesBool(false, true, data, nil)
