  ...
  identBacktick() {
    ...
    try {
      ...
      while (
        ...
        (((_la - 33) & ~0x1f) == 0 &&
          ((1 << (_la - 33)) &
            ((1 << (prqlParser.DOUBLE_QUOTE - 33)) |
              (1 << (prqlParser.SINGLE_QUOTE - 33)) |
              (1 << (prqlParser.TRIPLE_DOUBLE_QUOTE - 33)) |
              (1 << (prqlParser.TRIPLE_SINGLE_QUOTE - 33)) |
              (1 << (prqlParser.AND - 33)) |
              (1 << (prqlParser.OR - 33)) |
              (1 << (prqlParser.NOT - 33)) |
              (1 << (prqlParser.COALESCE - 33)) |
              (1 << (prqlParser.NULL_ - 33)) |
              (1 << (prqlParser.BOOLEAN - 33)) |
              (1 << (prqlParser.INTEGER - 33)) |
              (1 << (prqlParser.FLOAT - 33)) |
              (1 << (prqlParser.IDENT - 33)) |
              (1 << (prqlParser.IDENT_START - 33)) |
              (1 << (prqlParser.IDENT_NEXT - 33)) |
              (1 << (prqlParser.WHITESPACE - 33)) |
              (1 << (prqlParser.COMMENT - 33)) |
              (1 << (prqlParser.INTERVAL_KIND - 33)) |
              (1 << (prqlParser.STRING - 33)))) !==
            0)
      ) {
        this.state = 157;
        _la = this._input.LA(1);
