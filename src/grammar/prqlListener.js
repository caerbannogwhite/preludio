...
export default class prqlListener extends antlr4.tree.ParseTreeListener {
  ...
  // Enter a parse tree produced by prqlParser#program.
  enterProgram(ctx) {}

  // Exit a parse tree produced by prqlParser#program.
  exitProgram(ctx) {}

  // Enter a parse tree produced by prqlParser#programIntro.
  enterProgramIntro(ctx) {}

  // Exit a parse tree produced by prqlParser#programIntro.
  ...
  // Enter a parse tree produced by prqlParser#stmt.
  enterStmt(ctx) {}

  // Exit a parse tree produced by prqlParser#stmt.
  exitStmt(ctx) {}
