...
export default class preludioParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, "FUNC", "PRQL", "LET", "ARROW", "ASSIGN", 
                             ...
                             "MODEL", "EQ", "NE", "LE", "GE", "BAR", "COLON", 
                             "COMMA", "DOT", "DOLLAR", "RANGE", "LANG", 
                             "RANG", "LBRACKET", "RBRACKET", "LPAREN", "RPAREN", 
                             "UNDERSCORE", "BACKTICK", "DOUBLE_QUOTE", "SINGLE_QUOTE", 
                             "TRIPLE_DOUBLE_QUOTE", "TRIPLE_SINGLE_QUOTE", 
                             "AND", "OR", "NOT", "COALESCE", "NULL_", "BOOLEAN", 
                             "INTEGER", "FLOAT", "IDENT", "IDENT_START", 
    ...
    static ruleNames = [ "nl", "program", "programIntro", "funcDef", "funcDefName", 
                         ...
                         "stmt", "assignStmt", "pipeline", "inlinePipeline", 
                         "identBacktick", "funcCall", "funcCallParam", "namedArg", 
                         "assign", "multiAssign", "exprCall", "expr", "term", 
	...
	program() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << preludioParser.FUNC) | (1 << preludioParser.LET) | (1 << preludioParser.PLUS) | (1 << preludioParser.MINUS) | (1 << preludioParser.LBRACKET) | (1 << preludioParser.LPAREN) | (1 << preludioParser.BACKTICK))) !== 0) || ((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (preludioParser.NOT - 37)) | (1 << (preludioParser.NULL_ - 37)) | (1 << (preludioParser.BOOLEAN - 37)) | (1 << (preludioParser.INTEGER - 37)) | (1 << (preludioParser.FLOAT - 37)) | (1 << (preludioParser.IDENT - 37)) | (1 << (preludioParser.STRING - 37)))) !== 0)) {
	            this.state = 72;
	            this._errHandler.sync(this);
	...
	identBacktick() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << preludioParser.FUNC) | (1 << preludioParser.PRQL) | (1 << preludioParser.LET) | (1 << preludioParser.ARROW) | (1 << preludioParser.ASSIGN) | (1 << preludioParser.PLUS) | (1 << preludioParser.MINUS) | (1 << preludioParser.STAR) | (1 << preludioParser.POW) | (1 << preludioParser.DIV) | (1 << preludioParser.MOD) | (1 << preludioParser.MODEL) | (1 << preludioParser.EQ) | (1 << preludioParser.NE) | (1 << preludioParser.LE) | (1 << preludioParser.GE) | (1 << preludioParser.BAR) | (1 << preludioParser.COLON) | (1 << preludioParser.COMMA) | (1 << preludioParser.DOT) | (1 << preludioParser.DOLLAR) | (1 << preludioParser.RANGE) | (1 << preludioParser.LANG) | (1 << preludioParser.RANG) | (1 << preludioParser.LBRACKET) | (1 << preludioParser.RBRACKET) | (1 << preludioParser.LPAREN) | (1 << preludioParser.RPAREN) | (1 << preludioParser.UNDERSCORE) | (1 << preludioParser.DOUBLE_QUOTE))) !== 0) || ((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (preludioParser.SINGLE_QUOTE - 32)) | (1 << (preludioParser.TRIPLE_DOUBLE_QUOTE - 32)) | (1 << (preludioParser.TRIPLE_SINGLE_QUOTE - 32)) | (1 << (preludioParser.AND - 32)) | (1 << (preludioParser.OR - 32)) | (1 << (preludioParser.NOT - 32)) | (1 << (preludioParser.COALESCE - 32)) | (1 << (preludioParser.NULL_ - 32)) | (1 << (preludioParser.BOOLEAN - 32)) | (1 << (preludioParser.INTEGER - 32)) | (1 << (preludioParser.FLOAT - 32)) | (1 << (preludioParser.IDENT - 32)) | (1 << (preludioParser.IDENT_START - 32)) | (1 << (preludioParser.IDENT_NEXT - 32)) | (1 << (preludioParser.WHITESPACE - 32)) | (1 << (preludioParser.COMMENT - 32)) | (1 << (preludioParser.INTERVAL_KIND - 32)) | (1 << (preludioParser.STRING - 32)))) !== 0)) {
	            this.state = 163;
	            _la = this._input.LA(1);
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 1:
	                    ...
	                    this.state = 211;
	                    _la = this._input.LA(1);
	                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << preludioParser.STAR) | (1 << preludioParser.DIV) | (1 << preludioParser.MOD))) !== 0))) {
	                    this._errHandler.recoverInline(this);
	                    }
	                    else {
	                    	this._errHandler.reportMatch(this);
	                ...
	                case 5:
	                    ...
	                    this.state = 223;
	                    _la = this._input.LA(1);
	                    if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << preludioParser.EQ) | (1 << preludioParser.NE) | (1 << preludioParser.LE) | (1 << preludioParser.GE) | (1 << preludioParser.LANG) | (1 << preludioParser.RANG))) !== 0))) {
	                    this._errHandler.recoverInline(this);
	                    }
	                    else {
	                    	this._errHandler.reportMatch(this);
	...
	exprUnary() {
	    ...
	    try {
	        ...
	        this.state = 243;
	        _la = this._input.LA(1);
	        if(!(((((_la - 6)) & ~0x1f) == 0 && ((1 << (_la - 6)) & ((1 << (preludioParser.PLUS - 6)) | (1 << (preludioParser.MINUS - 6)) | (1 << (preludioParser.NOT - 6)))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
	...
	literal() {
	    ...
	    try {
	        ...
	        case 8:
	            ...
	            this.state = 257;
	            _la = this._input.LA(1);
	            if(!(((((_la - 41)) & ~0x1f) == 0 && ((1 << (_la - 41)) & ((1 << (preludioParser.INTEGER - 41)) | (1 << (preludioParser.FLOAT - 41)) | (1 << (preludioParser.IDENT - 41)))) !== 0))) {
	            this._errHandler.recoverInline(this);
	            }
	            else {
	            	this._errHandler.reportMatch(this);
	...
	list() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << preludioParser.PLUS) | (1 << preludioParser.MINUS) | (1 << preludioParser.LBRACKET) | (1 << preludioParser.LPAREN) | (1 << preludioParser.BACKTICK))) !== 0) || ((((_la - 37)) & ~0x1f) == 0 && ((1 << (_la - 37)) & ((1 << (preludioParser.NOT - 37)) | (1 << (preludioParser.NULL_ - 37)) | (1 << (preludioParser.BOOLEAN - 37)) | (1 << (preludioParser.INTEGER - 37)) | (1 << (preludioParser.FLOAT - 37)) | (1 << (preludioParser.IDENT - 37)) | (1 << (preludioParser.NEWLINE - 37)) | (1 << (preludioParser.COMMENT - 37)) | (1 << (preludioParser.STRING - 37)))) !== 0)) {
	            this.state = 266;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            while(_la===preludioParser.NEWLINE || _la===preludioParser.COMMENT) {
