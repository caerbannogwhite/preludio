...
func (i *__p_intern__) getBoolScalar() (bool, error) {
	...
	return false, fmt.Errorf("expecting bool scalar, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getBoolVector() ([]bool, error) {
	...
	return []bool{}, fmt.Errorf("expecting bool vector, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getIntScalar() (int, error) {
	...
	return 0, fmt.Errorf("expecting int scalar, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getIntVector() ([]int, error) {
	...
	return []int{}, fmt.Errorf("expecting int vector, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getInt64Scalar() (int64, error) {
	...
	return 0, fmt.Errorf("expecting int64 scalar, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getInt64Vector() ([]int64, error) {
	...
	return []int64{}, fmt.Errorf("expecting int64 vector, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getFloat64Scalar() (float64, error) {
	...
	return 0, fmt.Errorf("expecting float scalar, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getFloat64Vector() ([]float64, error) {
	...
	return []float64{}, fmt.Errorf("expecting float vector, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getStringScalar() (string, error) {
	...
	return "", fmt.Errorf("expecting string scalar, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getStringVector() ([]string, error) {
	...
	return []string{}, fmt.Errorf("expecting string vector, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getSymbol() (__p_symbol__, error) {
	...
	return "", fmt.Errorf("expecting symbol, got %s", describeValue(i.expr[0]))
}
...
func (i *__p_intern__) getDataframe() (dataframe.DataFrame, error) {
	...
	case dataframe.DataFrame:
		return v, nil
	default:
		return dataframe.DataFrame{}, fmt.Errorf("expecting dataframe, got %s", describeValue(v))
	}
}
...
func (i *__p_intern__) getList() (__p_list__, error) {
	...
	case __p_list__:
		return v, nil
	default:
		return nil, fmt.Errorf("expecting list, got %s", describeValue(v))
	}
}
	...
	case __p_list__:
		...
		for j, e := range l {
			...
			case bool:
				res[j] = v
			default:
				return nil, fmt.Errorf("expecting a list of bools, got %s", describeValue(e.getValue()))
			}
		}
		return series.NewSeriesBool(res, nil, false, i.vm.__context), nil

	default:
		return nil, fmt.Errorf("expecting list, got %s", describeValue(i.expr[0]))
	}
}
	...
	case __p_list__:
		...
		for j, e := range l {
			...
			case int64:
				res[j] = v
			default:
				return nil, fmt.Errorf("expecting a list of ints, got %s", describeValue(e.getValue()))
			}
		}
	...
	case __p_list__:
		...
		for j, e := range l {
			...
			case float64:
				res[j] = v
			default:
				return nil, fmt.Errorf("expecting a list of floats, got %s", describeValue(e.getValue()))
			}
		}
	...
	case __p_list__:
		...
		for j, e := range l {
			...
			case __p_symbol__:
				res[j] = string(v)
			default:
				return nil, fmt.Errorf("expecting a list of strings or symbols, got %s", describeValue(e.getValue()))
			}
		}
		return res, nil
